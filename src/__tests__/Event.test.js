...
test('renders event summary(title)', () => {
  ...
  //this test continued to return 'null'.  Not sure why.
...
test('renders event location', () => {
  ...
  test('renders event details button with the title(show details)', () => {
   ...
   test('by default event details section should be hidden', () => {
     ...
     test('shows details when user clicks on the button', async() => {
      const showDetailsButton = EventComponent.queryByText('details-btn');
  ...
  const hideDetailsButton = EventComponent.queryByText('details-btn');
